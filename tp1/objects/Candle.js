...
class Candle extends THREE.Object3D{
    ...
    constructor(cylinderHeight, cylinderRadius, cylinderMaterial, flameRadius, flameMaterial, position = { x: 0, y: 0, z: 0 }) {
        ...
        this.flameLight = new THREE.PointLight(0xbd7c04, 1.5, 0.5);
        shadowDefinitions.propertiesLightShadow(this.flameLight);
        this.flameLight.position.set(0, cylinderHeight / 2 + 0.010, 0);

        cylinderMesh.add(flameMesh);
        flameMesh.add(this.flameLight);
